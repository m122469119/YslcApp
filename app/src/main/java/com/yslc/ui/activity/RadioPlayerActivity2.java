 ...
 * @author HH
 */
public class RadioPlayerActivity2 extends BaseActivity implements
        OnClickListener {
    ...
    public class LocateReceive extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(style.equals("play")){//开始播放广播（更新UI）
                ...
                ToastUtil.showMessage(RadioPlayerActivity2.this, "下一首");
                if(isOnline){
                    getData();//下一首
                }else {
                    finish();
        ...
        HttpUtil.get(HttpUtil.PLAY_VEDIO, this, null,
                new JsonHttpResponseHandler() {
                    ...
                    public void onFailure(Throwable arg0, JSONObject json) {
                        ...
                        ToastUtil.showMessage(RadioPlayerActivity2.this, "加载失败,请刷新");
