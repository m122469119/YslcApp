 ...
 */
public abstract class BaseEnhancedQuickAdapter<T> extends QuickAdapter<T> {
     ...
     */
    public BaseEnhancedQuickAdapter(Context context, int layoutResId) {
     ...
     */
    public BaseEnhancedQuickAdapter(Context context, int layoutResId, List<T> data) {
